...
def dataloader(filepath):
    ...
    train = []
    val = []
    valset = [1,3,6,20,26,35,38,41,43,44,49,60,67,70,81,84,89,97,109,119,122,123,129,
              130,132,134,141,144,152,158,159,165,171,174,179,182,184,186,187,196]
    for index in range(200):
        if index in valset:
            val.append(image[index])
 #       else:
  #          train.append(image[index])
        train.append(image[index])
